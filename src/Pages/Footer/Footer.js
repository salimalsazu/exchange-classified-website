...
const Footer = () => {
    return (
        <footer className="p-6 bg-gradient-to-r from-primary to-secondary rounded-md text-white ">
            <div className="container grid grid-cols-2 mx-auto gap-x-3 gap-y-8 sm:grid-cols-3 md:grid-cols-4 mt-40 text-white ">
            ...
            <div className="flex items-center justify-center px-6 pt-12 mt-20 text-sm">
                <span className="text-white ">© Copyright 2022. All Rights Reserved by Salim Al Sazu </span>
            </div>
        </footer>
    );
};
